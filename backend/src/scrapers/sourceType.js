...
const ATS_PLATFORMS = new Set(['LEVER', 'GREENHOUSE', 'WORKDAY', 'WORKDAY_REST', 'TALEO', 'SMARTRECRUITERS', 'ICIMS', 'AVATURE', 'RECRUITEE', 'TEAMTAILOR', 'ASHBY', 'BAMBOOHR', 'PERSONIO', 'BREEZY', 'TRAFFIT']);
const AGGREGATOR_PLATFORMS = new Set(['ADZUNA', 'JOOBLE', 'CAREERJET', 'AVIATIONJOBSEARCH', 'REED', 'WHATJOBS']);
